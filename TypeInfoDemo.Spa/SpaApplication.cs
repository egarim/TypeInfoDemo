...
namespace TypeInfoDemo.Spa {
    public partial class TypeInfoDemoSpaApplication : SpaApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static TypeInfoDemoSpaApplication()
        {
        ...
        #endregion
        public TypeInfoDemoSpaApplication() : base()
        {
            Tracing.Initialize();
        ...
        private void TypeInfoDemoSpaApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
